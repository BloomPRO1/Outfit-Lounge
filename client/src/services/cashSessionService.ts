...
export const cashSessionService = {
  ...
  close: async (closing_balance: number, notes?: string, cashout_amount?: number): Promise<CashSession> => {
    const { data } = await api.post('/cash-sessions/close', { closing_balance, cashout_amount, notes });
    return data;
  },
